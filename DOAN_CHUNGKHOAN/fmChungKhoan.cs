...
namespace DOAN_CHUNGKHOAN
{
    public partial class fmChungKhoan : Form
    {
        ...
        {
            return "Data Source=KHANHS\\SQLSERVER;Initial Catalog=CHUNGKHOAN;User ID=sa;Password=123";
        }

        private string GetSQL()
        {
            return "SELECT MACP AS [MACP], GIA3_DM AS [Giá 3 Mua], KL3_DM AS [Khối Lượng 3 Mua], GIA2_DM AS [Giá 2 Mua], KL2_DM AS [Khối Lượng 2 Mua], GIA1_DM AS [Giá 1 Mua], KL1_DM AS [Khối Lượng 1 Mua], GIAKHOP AS [Giá Khớp], KL_KHOP AS [Khối Lượng Khớp], GIA1_DB AS [Giá 1 Bán], KL1_DB AS [Khối Lượng 1 Bán], GIA2_DB AS [Giá 2 Bán], KL2_DB AS [Khối Lượng 2 Bán], GIA3_DB AS [Giá 3 Bán], KL3_DB AS [Khối Lượng 3 Bán] FROM dbo.TRUCTUYEN";
        }
        ...
        private void dependency_OnChange(object sender, SqlNotificationEventArgs e)
        {
            ...
            changeCount += 1;
            {
                var withBlock = this.listBoxThongTin.Items;
                withBlock.Clear();
        ...
        private void btnDatLenh_Click(object sender, EventArgs e)
        {
            ...
            string strLenh = "EXEC SP_KHOPLENH_LO '" + txtMaCP.Text + "','" + dtpNgay.Value.ToString("dd-MM-yyyy")+ "','" + this.loaiGD + "'," + txtSoLuong.Text + "," + txtGiaDat.Text;
        ...
        private void radioMua_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void radioBan_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void groupBoxDatLenh_Enter(object sender, EventArgs e)
        {

        }

        private void groupBoxSoLenh_Enter(object sender, EventArgs e)
        {
        ...
        private void listBoxThongTin_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void groupBoxBGTT_Enter(object sender, EventArgs e)
        {
